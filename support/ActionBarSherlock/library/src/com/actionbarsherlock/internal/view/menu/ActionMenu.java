...
public class ActionMenu implements Menu {
	...
	public int addIntentOptions(int groupId, int itemId, int order,
        ...
        for (int i=0; i<N; i++) {
            final ResolveInfo ri = lri == null ? null : lri.get(i);
            Intent rintent = new Intent(
                ri == null ? intent : ri.specificIndex < 0 ? intent : specifics[ri.specificIndex]);
            rintent.setComponent(new ComponentName(
                    ri == null ? null : ri.activityInfo.applicationInfo.packageName,
                    ri == null ? null : ri.activityInfo.name));
            final MenuItem item = add(groupId, itemId, order, ri == null ? null : ri.loadLabel(pm))
                    .setIcon(ri == null ? null : ri.loadIcon(pm))
                    .setIntent(rintent);
            if (outSpecificItems != null && ri != null && ri.specificIndex >= 0) {
