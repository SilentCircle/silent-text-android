...
//
#ifndef Included_siren_h	/* [ */
#define Included_siren_h
...
extern NSString *const kSirenSigKey;
...
@interface Siren : NSObject <NSCopying>
...
@property (strong, nonatomic) NSString  *multicastKey;
...
- (XMPPMessage *) multicastChatMessageToJIDs: (NSArray *) jids forThread:(NSString*)thread domain:(NSString*)domain;
